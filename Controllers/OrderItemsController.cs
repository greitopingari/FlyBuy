...
namespace FlyBuy.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "Id", "AgeCategory");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Price,Quantity,OrderId,ProductId")] OrderItem orderItem)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Orders, "Id", "CustomerAddress", orderItem.OrderId);
            ViewData["ProductId"] = new SelectList(_context.Products, "Id", "AgeCategory", orderItem.ProductId);
            return View(orderItem);
        }
